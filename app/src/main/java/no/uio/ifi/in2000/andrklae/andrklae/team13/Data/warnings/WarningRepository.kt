...
/*
fun findClosestCoordinate(myCoordinate: WarningRepository.Coordinate2, coordinates: List<Any>): WarningRepository.Coordinate2? {
    var closestCoordinate: WarningRepository.Coordinate2? = null
    var minDistance = Double.MAX_VALUE
    println("Running test")
            ...
            if(it.size == 1){
                ...
                it.forEach{coords ->
                    ...
                    if(coords is ArrayList<*>){
                        ...
                        val distance = calculateDistance(myCoordinate,
                            WarningRepository.Coordinate2(
                        ...
                        if (distance < minDistance) {
                            minDistance = distance
                            closestCoordinate = WarningRepository.Coordinate2(
                                coords[0].toString().toDouble(),
                                coords[1].toString().toDouble()
                            )
                        }
